...
public class GraphAdjList extends Graph {
	...
	public List<Integer> getNeighbors(int v) {
		...
		//you could've just returned adjListsMap.get(v),
		//but for a security reason, we return a copy of the list.
	}
	 ...
	 */		
	 public List<Integer> getDistance2(int v) {
		 ...
		 for(Integer firHop : getNeighbors(v)) 
			 for(Integer secHop : getNeighbors(firHop))
				 retList.add(secHop);
	...
	public static void main(String[] args) {
		...
		System.out.println("2hop : " + simpleTest.getDistance2(5));
	}
